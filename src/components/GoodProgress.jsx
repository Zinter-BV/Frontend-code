      ...
      <div className="flex items-center w-full justify-between">
        <div className="flex w-[80%] justify-between items-center ">
          <div className="flex relative">
            <div
              className={`absolute top-4 left-[30px] ${
                activeTab > 1 ? "bg-[#248CD9]" : "bg-[#248CD9]"
              } h-[2px] w-[140px] rounded-[2px] mobileProgressArrow`}
            ></div>
            <div className="mr-4">
              {activeTab > 1 ? (
          ...
          <div className="flex relative">
            <div
              className={`absolute top-4 left-[30px] ${
                activeTab > 2 ? "bg-[#248CD9]" : "bg-[#248CD9]"
          ...
          <div className="flex relative">
            <div
              className={`absolute top-4 left-[30px] ${
                activeTab > 3 ? "bg-[#248CD9]" : "bg-[#248CD9]"
              }  h-[2px] w-[140px]  mobileProgressArrow rounded-[2px] `}
            ></div>
            <div className="mr-4">
              {activeTab > 3 ? (
