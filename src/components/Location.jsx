...
const Location = ({
  ...
  const handleOnPlacesChange = () => {
    let address = fromInputRef.current.getPlaces();
    console.log(address);
  };
            ...
            <div className="relative">
              ...
              >
                {/* <input
                  ...
                  className="text-[#707070] ml-2 font-sans border text-[16px] leading-[25.6px] bg-transparent outline-none flex-1 min-w-0"
                /> */}
