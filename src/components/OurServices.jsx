    ...
    return (
        <div className="services_container">
            <div className="our_services_container">
                ...
                <div>Instead, we connect customers with trusted
                    and professional third-party moving service providers.
                    We ensure a seamless booking and logistics experience
                    by leveraging technology to match users with the best
                    available movers. Our services include</div>
            </div>
            <div>
                <div className="our_services_card_container">
                    ...
                    <div className="our_services_card">
                        ...
                        <span>Efficient and reliable
                            business relocations with
                            minimal downtime</span>
                    </div>
                    <div className="our_services_card">
                        <img src={customerSolution} alt="" />
                        <h3>Customized Solutions</h3>
                        <span>Personalized services to
                            meet unique transportation
                            needs</span>
                    </div>
                </div>
                <div className="our_services_card_sub_container">
                    <div className="our_services_card_sub">
                        ...
                        <span>As a logistics tech company, 
                            Zinter BV integrates advanced 
                            technology to optimize processes 
                            and enhance the customer experience</span>
                    </div>
                    <div className="our_services_card_sub">
                        <img src={imageRecognition} alt="" />
                        <h3>AI Image Recognition for Inventory</h3>
                        <span>Enhancing inventory management by 
                            leveraging AI to accurately recognize, 
                            categorize, and track items, making moves 
                            more efficient and organized.</span>
                    </div>
                </div>
            </div>
        </div>
