...
const ourVision = () => {
    return (
        <div className="container_our_vision"> 
                    ...
                    <div className="card_our_vision">
                        <div className="first_card">
                            ...
                            <div className="first_card_text">
                                ...
                                <span>Duis aute irure dolor in reprehen
                                derit in voluptate velit esse</span>
                            </div>
                        </div>
            ...
            <div className="second_container_vision">
                <h2>
                At Zinter, we envision a world where 
                logistics is streamlined, intelligent, 
                and effortless. 
                </h2>
                <span>
                By leveraging cutting-edge technology, 
                 aim to provide a hassle-free experience that 
                 eliminates common challenges associated 
                 with moving and transportation services.  
                 Our goal is to create an all-encompassing logistics 
                 infrastructure that caters to diverse needs, 
                 from residential relocations to commercial moves.
                </span>
