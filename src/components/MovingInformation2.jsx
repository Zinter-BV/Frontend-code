...
const MovingInformation2 = ({
  ...
  return (
    <div
      className={`ml-4 movingInfoBox w-full ${
        hasOpenSections ? " h-fit" : "pb-5"
      }`}
    >
      <div
      ...
      >
        ...
        <div
          className={`p-[24px] movingInformationContainer w-[600px] h-fit ${
            hasOpenSections ? "mb-50" : "pb-5"
          }`}
        >
          <div className="mb-6">
