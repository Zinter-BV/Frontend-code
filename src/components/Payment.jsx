  ...
  return (
    <div className="ml-4 h-fit w-full">
      <div className="overflow-y-scroll pb-[70px] custom-scroll ">
        ...
        <div className="mb-5 mt-3 border-[1px] w-full h-[146px] flex justify-center items-center rounded-[20px] border-[#136AB5] ">
          <div className=" w-[95%] flex items-center justify-between h-[75%]">
            <div className="flex flex-col relative h-full justify-between">
             ...
             bg-[#E3E8EF] h-[28px] w-[2px] rounded-[2px] `}
              ...
              <div className="flex items-center ">
                ...
                <div className="bg-[#f7f7f7] w-[400px] ml-3 flex items-center rounded-[10px] p-[10px] ">
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
        ...
        <div className="rounded-[12px] h-fit w-full flex-col mt-5 flex border-[1px] p-[16px] border-[#e3e3e3] ">
          <div className="items-center w-full justify-between flex">
            <div className="flex items-center">
              ...
              <p className="font-sans ml-2 text-[16px] text-[#121212] leading-[25.6px] ">
          ...
          <div className="mt-4">
            <div className="mb-4">
              ...
              <div className="h-[50px] mt-1 flex items-center ">
                ...
                <input
                  ...
                  className="w-full border-[1px] h-full pl-2 outline-none rounded-r-[6px] "
                />
              </div>
            </div>
            ...
            <div className="flex mt-3 items-center ">
              ...
              />
              <label
                className="font-sans font-extralight ml-2 text-[16px] text-[#555]"
                htmlFor="check"
              >
