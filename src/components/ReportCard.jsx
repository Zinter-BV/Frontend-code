        ...
        <div className="flex items-center  ">
          <div className="bg-[#f7f7f7] w-[400px] flex items-center rounded-[10px] p-[10px] ">
            <div className="flex items-center">
              ...
              <p className="text-[#b8b8b8] ml-2 font-light font-sans text-[12px] leading-[25.6px] ">
                From
              </p>
            </div>
            <div className="flex">
              ...
              <p className="text-[#707070] ml-2 movingContainerFromLocation font-sans text-[12px] leading-[25.6px]">
                Keizersgracht
              </p>
            </div>
          </div>
        </div>
        <div className="bg-[#E3E8EF] h-[16px] ml-4 w-[3px] "></div>
        <div className="flex items-center  ">
          <div className="bg-[#f7f7f7] w-[400px]  flex items-center rounded-[10px] p-[10px] ">
            <div className="flex items-center">
              <div className="">
            ...
            <div className="flex">
              <p className="text-[#b8b8b8] ml-2 font-light font-sans text-[12px]">
                -
              </p>
              <p className="text-[#707070] movingContainerFromLocation ml-2 font-sans text-[12px] leading-[25.6px]">
                Rozengracht
              </p>
            </div>
          </div>
