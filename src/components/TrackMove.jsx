...
//         throw new Error(
//           response.data?.responseMessage || "No tracking data available"
//         );
//       }
...
//     retry: 3,
//     staleTime: 0,
//     enabled: !!code?.result, // Only run query if code exists
//   });
...
//   // Get status flags from API - safely handle null/undefined
//   const hasArrived = data?.result?.hasArrived || false;
//   const inTransit = data?.result?.inTransit || false;
//   const isCompleted = data?.result?.isCompleted || false;
