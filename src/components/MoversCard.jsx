...
const MoversCard = ({ makeActive }) => {
  return (
    <div
      onClick={makeActive}
      className="relative w-[385px] h-fit border-[1px] cursor-pointer pb-3 border-[#e3e3e3] rounded-[16px]"
    >
      ...
      <div className="border-b-[1px] pb-[20px] border-[#e3e3e3]">
        <div className="w-[90%] mx-auto ">
          <div className="flex items-center mt-2 justify-between">
            <p className="font-sans text-[24px] leading-[38.5px] font-thin ">
              {" "}
              Independent Movers
            </p>
      ...
      <div className="w-[90%] mx-auto mt-3 ">
        <p className="text-[#9e9e9e] font-thin text-[16px] leading-[25.6px] font-sans ">
          22 miles away
        </p>
        <div className="flex items-center mt-2 justify-between">
          <p className="font-sans text-[32px] leading-[38.5px] font-normal ">
            {" "}
            $921
          </p>
