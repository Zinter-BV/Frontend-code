...
const PaymentSuccess = ({ closeSuccessModal }) => {
  return (
    <div className="fixed top-0 z-50 left-0 backdrop-blur-[3px] bg-[rgba(0,0,0,0.10)] h-full w-full flex justify-center items-center">
      <div className="flex flex-col rounded-[12px] bg-white w-[470px] h-fit justify-center">
        <div className="flex flex-col  justify-center items-center px-[24px] pt-[24px] ">
          ...
          <p className="text-[16px] text-center mb-3 font-light leading-[25.6px] w-[90%] text-[#525252] font-sans ">
            Link to track move and move details have been sent to your email
            address
          </p>
          <div className="w-[90%] mx-auto rounded-[8px] border-[1px] p-4 border-[#e3e3e3] h-fit mb-4 ">
            <p className="font-sans text-center text-[14px] text-[#707070] ml-2 leading-[25.6px] ">
              Move Date & Location
            </p>
            <div className="flex justify-center items-center">
              <p className="text-[#121212] font-sans text-[18px] font-bold ">
                25th March, 2025,
              </p>
              <p className="text-[#121212] font-sans text-[18px] font-bold ml-2 ">
                10:00 AM
              </p>
            </div>
            <p className="text-[#121212] mt-2 text-center font-sans text-[18px] font-bold ">
